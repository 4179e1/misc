...
Id3 *id3_multi_new_from_tag (Id3 *id3)
{
	Id3 *mul;
	mul = id3_new ();
	if (id3->tag1)
	{
		mul->tag1 = (Id3v1 *)id3v1_multi_new_from_v1 (id3->tag1);
	}
	/* TODO: Id3v2 */
	return mul;
}

void id3_multi_write_to_path (Id3 *id3, const gchar *path)
{
	FILE *file;
	...
	id3_multi_write_to_file (id3, file);
	Fclose (file);
}

void id3_multi_write_to_file (Id3 *id3, FILE *file)
{
	if (id3->tag1)
	{
		id3v1_multi_write_to_file ((Id3v1Multi*)id3->tag1, file);
	}
	/* TODO: Id3v2 */
}
