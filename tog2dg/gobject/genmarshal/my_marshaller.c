...
void
_my_mayshal_INT__VOID (GClosure     *closure,
...
void
_my_mayshal_VOID__OBJECT_INT (GClosure     *closure,
                              GValue       *return_value G_GNUC_UNUSED,
                              guint         n_param_values,
                              const GValue *param_values,
                              gpointer      invocation_hint G_GNUC_UNUSED,
...
void
_my_mayshal_UINT__BOOLEAN (GClosure     *closure,
                           GValue       *return_value G_GNUC_UNUSED,
                           guint         n_param_values,
                           const GValue *param_values,
                           gpointer      invocation_hint G_GNUC_UNUSED,
                           gpointer      marshal_data)
{
  typedef guint (*GMarshalFunc_UINT__BOOLEAN) (gpointer     data1,
                                               gboolean     arg_1,
                                               gpointer     data2);
  register GMarshalFunc_UINT__BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  guint v_return;
  ...
  callback = (GMarshalFunc_UINT__BOOLEAN) (marshal_data ? marshal_data : cc->callback);
...
void
_my_mayshal_BOOLEAN__BOOLEAN (GClosure     *closure,
                              GValue       *return_value G_GNUC_UNUSED,
                              guint         n_param_values,
                              const GValue *param_values,
                              gpointer      invocation_hint G_GNUC_UNUSED,
