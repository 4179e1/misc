...
{                
	...
	gtk_box_pack_start (GTK_BOX (left_vbox), left_panel, TRUE, TRUE, 0);
...
//	gtk_box_pack_start (GTK_BOX (vbox), notebook, TRUE, TRUE, 0);
	...
	tables = add_page (left_panel, "Tables");
	views = add_page (left_panel, "Views");
	indexes = add_page (left_panel, "Indexes");
	triggers = add_page (left_panel, "Triggers");
