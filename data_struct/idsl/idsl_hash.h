...
idsl_hash_t
idsl_hash_alloc (const char* NAME,
		idsl_alloc_func_t ALLOC_F,
		idsl_free_func_t FREE_F,
		idsl_key_func_t KEY_F,
		idsl_hash_func_t HASH_F,
		unsigned short INITIAL_ENTRIES_NB);
void
...
idsl_hash_t
idsl_hash_set_name (const idsl_hash_t H);
idsl_element_t
idsl_hash_insert (idsl_hash_t H, void* VALUE);
idsl_elemnet_t
isdl_hash_remove (idsl_hash_t H, const char* KEY);
idsl_hash_t
idsl_hash_delete (idsl_hash_t H, const char* KEY);
idsl_hash_t
idsl_hash_modify (idsl_hash_t H, unsigned short NEW_ENTRIES_NB, unsigned NEW_LISTS_MAX_SIZE);
...
void idsl_hash_write (const idsl_hash_t H, idsl_write_func_t WRITE_F, FILE* OUTPUT_FILE, void* USER_DATA);
void idsl_hash_write_xml (const idsl_hash_t H, idsl_write_func_t WRITE_F, FILE* OUTPUT_FILE, void* USER_DATA);
void idsl_hash_dump (const idsl_hash_t H, idsl_write_func_t WRITE_F, FILE* OUTPUT_FILE, void* USER_DATA);
#endif /* _IDSL_HASH_H */
