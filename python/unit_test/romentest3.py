...
class ToRomanBadInput (unittest.TestCase):
	def testTooLarge (self):
		...
		self.assertRaises (roman3.OutOfRangeError, roman3.toRoman, 5000)
...
class FromRomanBadInput (unittest.TestCase):
	...
	def testBlank (self):
		...
		self.assertRaises(roman3.InvalidRomanNumeralError, roman3.fromRoman, "")
...
class CaseCheck (unittest.TestCase):
	...
	def testFromRomanCase (self):
		...
		for integer in range (1, 5000):
			...
			self.assertRaises (roman3.InvalidRomanNumeralError, roman3.fromRoman, numeral.lower())
