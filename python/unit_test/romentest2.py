...
class ToRomanBadInput (unittest.TestCase):
	def testTooLarge (self):
		...
		self.assertRaises (roman2.OutOfRangeError, roman2.toRoman, 5000)
...
class FromRomanBadInput (unittest.TestCase):
	...
	def testBlank (self):
		...
		self.assertRaises(roman2.InvalidRomanNumeralError, roman2.fromRoman, "")
...
class CaseCheck (unittest.TestCase):
	...
	def testFromRomanCase (self):
		...
		for integer in range (1, 5000):
			...
			self.assertRaises (roman2.InvalidRomanNumeralError, roman2.fromRoman, numeral.lower())
