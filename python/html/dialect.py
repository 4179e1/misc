...
class Dialectizer (BaseHTMLProcessor):
	...
	def process (self, text):
		...
		# substituions (actual substition are defined in descendant)
...
class ChefDialectizer (Dialectizer):
	""" convert HTML to Swedish Chef-speak
		...
		based on classic chef.x, copyright (c) 1992, 1993 John Hagerman
	"""
	subs = ((r'a([nu])', r'u\1'),
			(r'A([nu])', r'U\1'),
			(r'a\B', r'e'),
